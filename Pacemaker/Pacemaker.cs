...
namespace Pacemaker
{
    [BepInPlugin("com.rhythmdr.pacemaker", "Pacemaker", "1.0.0")]
    [BepInProcess("Rhythm Doctor.exe")]
    public class Pacemaker : BaseUnityPlugin
    {
        private void Awake()
        {
            Harmony.CreateAndPatchAll(typeof(CustomAnimationPatch));
        }

        private class CustomAnimationFields
        {
        ...
        private static class CustomAnimationPatch
        {
            [HarmonyPrefix]
